...
Build Package: This stage builds the WordPress artifact and performs necessary checks.
Deploy to UAT: This stage deploys the built artifact to the UAT environment.
Deploy to Production: This stage deploys the built artifact to the production environment.
